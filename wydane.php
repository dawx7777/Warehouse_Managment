...
<?php endif ?>
			...
			<table class="table table-bordered"> <thead> <tr> <th>Imie</th> <th>Nazwisko</th> <th>Produkt</th> <th>Ilość</th> <th>Numer indeksu</th> <th>Data</th><th>Status</th>  </tr> </thead> <tbody>
            
	
	
                <?php
             if(isset($_POST['btn_pdf_wydane'])){
