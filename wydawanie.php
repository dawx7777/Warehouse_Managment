    ...
    <div class="row justify-content-center mt-0">
        <div class="col-11 col-sm-9 col-md-7 col-lg-6 text-center p-0 mt-3 mb-2">
            <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                <h2><strong>Wydawanie towaru</strong></h2>
                <p>Dodaj produkty z paragonu lub WZ</p>
                <div class="row">
                    <div class="col-md-12 mx-0">
                    <form action="do_wydania.php" method="POST">
                            <button type="submit" name="btn_pdf" class="button" ><span>Do wydania</span></button>
                           </form>
                        </br>
